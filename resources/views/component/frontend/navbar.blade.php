 <!-- START: HEADER -->
 <header class="{{ \Route::current()->getName() == 'frontend.index' ? 'absolute' : '' }} w-full z-50 px-4">
     <div class="container mx-auto py-5">
         <div class="flex flex-stretch items-center">
             <div class="w-56 items-center flex">
                 <a href="{{ route('frontend.index') }}" class=""><img
             ...
             <div class="w-auto">
                 <ul class="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
                     ...
                     <li class="mx-3 py-6 md:py-0">
                         <a href="#"
                             class="text-black {{ \Route::current()->getName() == 'frontend.index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Showcase</a>
                     </li>
                     <li class="mx-3 py-6 md:py-0">
                         <a href="#"
                             class="text-black {{ \Route::current()->getName() == 'frontend.index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Catalog</a>
                     </li>
                     <li class="mx-3 py-6 md:py-0">
                         <a href="#"
                             class="text-black {{ \Route::current()->getName() == 'frontend.index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Delivery</a>
                     </li>
                     <li class="mx-3 py-6 md:py-0">
                         <a href="#"
                             class="text-black {{ \Route::current()->getName() == 'frontend.index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Rewards</a>
                     </li>


                     {{-- Kalo sudah login maka yang muncul adalah ini --}}
                     @auth
                         <li class="mx-3 py-6 md:py-0">
                             <a href="{{ route('dashboard.index') }}"
                                 class="text-black {{ \Route::current()->getName() == 'frontend.index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Dashboard</a>
                         </li>
                     @endauth

                     {{-- Kalo belum login makan muncul ini --}}
                     @guest
                         <li class="mx-3 py-6 md:py-0">
                             <a href="{{ route('login') }}"
                                 class="text-black {{ \Route::current()->getName() == 'frontend.index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Login</a>
                         </li>
                     @endguest
                 ...
                 <ul class="items-center flex">
                     <li class="ml-6 block md:hidden">
                         <button id="menu-toggler"
                             class="relative flex z-50 items-center justify-center w-8 h-8 text-black {{ \Route::current()->getName() == 'frontend.index' ? 'md:text-white' : 'md:text-black' }} focus:outline-none">
                     ...
                     <li class="ml-6">
                         <a id="header-cart"
                             class="flex items-center justify-center w-8 h-8 text-black {{ \Route::current()->getName() == 'frontend.index' ? 'md:text-white' : 'md:text-black' }}"
                             href="{{ route('frontend.carts') }}">
