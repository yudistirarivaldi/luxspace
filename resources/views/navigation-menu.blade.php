            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->roles == 'ADMIN')
                        ...
                        <x-jet-nav-link href="{{ route('dashboard.transaction.index') }}" :active="request()->routeIs('dashboard.transaction.create')">
                            {{ __('Transaction') }}
                        </x-jet-nav-link>

                        <x-jet-nav-link href="{{ route('dashboard.user.index') }}" :active="request()->routeIs('dashboard.user.create')">
                            {{ __('User') }}
                        </x-jet-nav-link>
                    @endif
